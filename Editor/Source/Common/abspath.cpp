...
/*forward*/ int chdir_and_set_global_record( const EmacsString &buf );
/*forward*/ EmacsString save_abs( const EmacsString &fn );
/*forward*/ int expand_and_default( const EmacsString &fn, const EmacsString &dn, EmacsString &ou );
