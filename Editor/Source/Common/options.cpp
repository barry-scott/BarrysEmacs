...
/*forward*/ void scan_map( KeyMap *kmap, void (*proc)( BoundName *b, EmacsString &keys, int range ), int fold_case );
/*forward*/ static void scan_map_inner( KeyMap *kmap, void (*proc)( BoundName *b, EmacsString &keys, int range ), struct key_scan_history *history, EmacsString keys, int fold_case );
/*forward*/ static void describe1( BoundName *b, EmacsString &keys, int range );
...
/*forward*/ static BoundName *autodefinekeymap( void );
/*forward*/ static void perform_bind( KeyMap **tbl, BoundName *name );
...
/*forward*/ static int break_point( ProgramNode *p, int larg );
/*forward*/ static int trace( ProgramNode *p, int larg );
/*forward*/ static int breaktrace( ProgramNode *p, BoundName *b, int larg );
...
/*forward*/ static EmacsString decompile( ProgramNode *p, int larg, int indent, int depth );
/*forward*/ static void decompile_inner( ProgramNode *p, int depth, int indent );
