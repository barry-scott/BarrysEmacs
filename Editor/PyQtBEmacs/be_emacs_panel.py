...
theme_dark = Theme(
    ...
    all_colours=(
        ...
        ColourInfo('SYNTAX_TYPE_STRING1',     U_('String 1'),     SYNTAX_TYPE_STRING1,    (  0,192,  0),  ( 48, 48, 48)),
        ColourInfo('SYNTAX_TYPE_STRING2',     U_('String 2'),     SYNTAX_TYPE_STRING2,    (  0,192,  0),  ( 48, 48, 48)),
        ColourInfo('SYNTAX_TYPE_STRING3',     U_('String 3'),     SYNTAX_TYPE_STRING3,    (  0,192,  0),  ( 48, 48, 48)),
        ColourInfo('SYNTAX_TYPE_COMMENT1',    U_('Comment 1'),    SYNTAX_TYPE_COMMENT1,   (  0,192,  0),  ( 48, 48, 48)),
        ColourInfo('SYNTAX_TYPE_COMMENT2',    U_('Comment 2'),    SYNTAX_TYPE_COMMENT2,   (  0,192,  0),  ( 48, 48, 48)),
        ColourInfo('SYNTAX_TYPE_COMMENT3',    U_('Comment 3'),    SYNTAX_TYPE_COMMENT3,   (  0,192,  0),  ( 48, 48, 48)),
