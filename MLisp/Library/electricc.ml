...
(save-window-excursion
    (temp-use-buffer "electric-c-tmp")
    ...
    (modify-syntax-table "keyword-2" "const_cast")
    (modify-syntax-table "keyword-2" "delete")
    (modify-syntax-table "keyword-2" "dynamic_cast")
    ...
    (modify-syntax-table "keyword-2" "reinterpret_cast")
    (modify-syntax-table "keyword-2" "static_cast")
    ...
    (modify-syntax-table "keyword-2" "wchar_t")
