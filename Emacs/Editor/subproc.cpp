...
/*forward*/ void filter_through(int n, const EmacsString &command );
...
#if defined( SUBPROCESSES )
# ifdef vms
/*forward*/ static void exec_bf( const EmacsString &bufname, int display, const EmacsString &input, int erase, ... );
...
# endif
# ifdef __unix__
/*forward*/ static void exec_bf( const EmacsString &bufname, int display, const EmacsString &input, int erase, char *command, ... );
# endif
#if defined( _NT )
static void exec_bf
	(
