...
cc_flags = -g -D_DEBUG -D_BSD_SOURCE -D_XOPEN_SOURCE -D_POSIX_SOURCE -I. -I/usr/X11R6/include -I$(MOTIFINC) -c
...
$(edit_obj)linux_ld_fix.o : $(edit_src)linux_ld_fix.cpp
	@ echo Info: Compile $(edit_src)linux_ld_fix.cpp
	@ $(cpp) $(cc_flags) -o $(edit_obj)linux_ld_fix.o $(edit_src)linux_ld_fix.cpp
...
$(edit_obj)bemacs_server_static : $(obj_files) $(edit_obj)linux_ld_fix.o
	@ echo Info: Link $(edit_obj)bemacs_server_static
	$(ldstatic) -Wl,-Bstatic -o $(edit_obj)bemacs_server_static $(obj_files) $(edit_obj)linux_ld_fix.o -lXm -lXpm -lXp -lXt -lSM -lICE -lXext -lX11
...
$(edit_obj)ptyopen_svr4.o : $(edit_src)ptyopen_svr4.cpp
	@ echo Info: Compile $(edit_src)ptyopen_svr4.cpp
...
##################################################################################
depend:
	cp freebsd.mak Makefile
	makedepend -p$(edit_obj) -D__unix__ -D__FreeBSD__ $(cc_flags) \
emacs_init.cpp \
abbrev.cpp \
abspath.cpp \
arith.cpp \
