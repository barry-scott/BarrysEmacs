...
bool EmacsExternImageOsInfo::isLoaded()
	{
	return module != NULL;
	}

bool EmacsExternImageOsInfo::load( const EmacsString &_file )
	{
	file = _file;
...
bool EmacsExternImageOsInfo::unload()
	{
	if( module != NULL )
...
void *EmacsExternImageOsInfo::symbolValue( const EmacsString &symbol )
	{
