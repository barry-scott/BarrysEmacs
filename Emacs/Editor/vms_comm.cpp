...
/*forward*/ static void mail_box_AST_routine( ProcessChannel *chan );
/*forward*/ static void termination_AST( EmacsProcess *dead_process );
/*forward*/ int process_channel_interrupts( void );
/*forward*/ static void close_channel( ProcessChannel *chan );
/*forward*/ static int setup_channel( ProcessChannel *chan );
/*forward*/ int start_DCL_process( void );
/*forward*/ static EmacsProcess * get_process_arg( void );
/*forward*/ static BoundName *get_procedure_arg( void );
...
/*forward*/ void proc_de_ref_buf( EmacsBuffer *b );
