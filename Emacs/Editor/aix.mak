...
cc_opt=-g
cc_flags = -c $(cc_opt) -D_DEBUG -I. -I/usr/include/Motif1.2
ld_flags = $(cc_opt)
cpp = xlC
ldstatic = xlC $(ld_flags)
lddynamic = xlC $(ld_flags)
#edit_src=
pure=purify purecov
...
$(edit_obj)bemacs : $(edit_obj)emclient.o $(edit_obj)em_stat.o $(edit_obj)emstring.o $(edit_obj)stub_rtl.o
	@ echo Make: $@
	@ $(cpp) -o $(edit_obj)bemacs -g $(edit_obj)emclient.o $(edit_obj)em_stat.o $(edit_obj)emstring.o $(edit_obj)stub_rtl.o
...
$(edit_obj)bemacs_server : $(obj_files)
	@ echo Make: $@
	@ $(lddynamic) -o $(edit_obj)bemacs_server $(obj_files) \
