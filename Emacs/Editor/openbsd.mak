...
CC=/usr/bin/gcc -pipe
CXX=/usr/bin/g++ -pipe
cc_flags = -g -D_DEBUG -I. -I/usr/X11R6/include -I/usr/local/include -c
...
$(edit_obj)bemacs_server_static : $(obj_files)
	...
	$(ldstatic) -o $(edit_obj)bemacs_server_static $(obj_files) -lXm -lXp -lXt -lSM -lICE -lXext -lX11 $(EXTRALIBS) 2>&1 | c++filt
