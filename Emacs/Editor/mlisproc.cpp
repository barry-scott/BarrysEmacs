...
/*forward*/ int exec_prog( ProgramNode *p );
...
/*forward*/ void do_release( Expression *e );
/*forward*/ int star_define_function( void );
/*forward*/ int define_function( void );
/*forward*/ static int define_function_inner(BoundName *proc);
...
/*forward*/ void perform_set( VariableName *v, Expression &new_e, int setting_default );
/*forward*/ static void perform_set_array( VariableName *v );
...
/*forward*/ void print_expr( ProgramNode *p, int depth );
