...
Release:	@#@format:%(build)d@#@
Summary:	Barry's Emacs @#@version@#@ text editor for X11 and ANSI terminals
Copyright:	Barry A. Scott (c) 1990-@#@format:%(year)s@#@
Group:		Applications/Editors
Packager:	Barry A. Scott <barry@barrys-emacs.org>
%description
Barry's Emacs @#@version@#@ text editor for X11 and ANSI terminals.
