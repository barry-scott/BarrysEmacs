...
begin
	...
	begin
		...
		begin
			...
			rc := InstExec(uninstall_image, uninstall_params, ExpandConstant('{src}'), True, True, SW_SHOWNORMAL, Error);
			if not rc or Error <> 0 then
...
Source: "vc6redist\mfc42.dll";		DestDir: "{sys}"; CopyMode: alwaysskipifsameorolder; Flags: restartreplace uninsneveruninstall regserver
Source: "vc6redist\msvcp60.dll";	DestDir: "{sys}"; CopyMode: alwaysskipifsameorolder; Flags: restartreplace uninsneveruninstall
Source: "vc6redist\msvcirt.dll";	DestDir: "{sys}"; CopyMode: alwaysskipifsameorolder; Flags: restartreplace uninsneveruninstall
Source: "vc6redist\msvcrt.dll";		DestDir: "{sys}"; CopyMode: alwaysskipifsameorolder; Flags: restartreplace uninsneveruninstall
; end VC system files
...
Source: "..\Editor\ExternalInclude\BarrysEmacs.h"; DestDir: "{app}\Library"
Source: "..\Editor\ExternalInclude\BarrysEmacs.tlb"; DestDir: "{app}\Library"
...
[Registry]
Root: HKCR; Subkey: "BarrysEmacsCommand"; ValueType: string; ValueData: "BEmacs Command"
...
Root: HKCR; Subkey: "BarrysEmacsMLisp"; ValueType: string; ValueData: "BEmacs MLisp"
...
Root: HKCR; Subkey: "BarrysEmacsDocument"; ValueType: string; ValueData: "BEmacs"
...
Root: HKCR; Subkey: "BarrysEmacsDocumentII"; ValueType: string; ValueData: "BEmacs II"
...
Root: HKCR; Subkey: "BarrysEmacsDocumentIII"; ValueType: string; ValueData: "BEmacs III"
...
Root: HKCR; Subkey: "BarrysEmacsDocumentIV"; ValueType: string; ValueData: "BEmacs IV"
...
Root: HKCR; Subkey: "BarrysEmacsDocumentV"; ValueType: string; ValueData: "BEmacs V"
...
Root: HKCR; Subkey: "*\shell\Edit with Barry's Emacs"; ValueType: string; ValueData: "Edit with &Barry's Emacs";
Root: HKCR; Subkey: "*\shell\Edit with Barry's Emacs\command"; ValueType: string; ValueData: "{app}\bemacs.exe ""%1""";

Root: HKCR; Subkey: "Drive\shell\Barry's Emacs Here"; ValueType: string; ValueData: "Barry's Emacs &Here"
...
Root: HKCR; Subkey: "Directory\shell\Barry's Emacs Here"; ValueType: string; ValueData: "Barry's Emacs &Here"
...
;
Root: HKCR; SubKey: ".ml"; ValueType: string; ValueData: "BarrysEmacsMLisp"; Tasks: "option_register_emacs_open_ml"
Root: HKCR; SubKey: ".mlp"; ValueType: string; ValueData: "BarrysEmacsCommand"; Tasks: "option_register_emacs_open_ml"
